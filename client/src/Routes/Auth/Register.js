        ...
        <div className="row g-0">
          <div className="col-md-8 p-3 right-wrapper">
            <form className="register-form" onSubmit={handleSubmit}>
              ...
              <h1 className="mb-4 fw-bold">New Voter Registration</h1>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                {formData.email.error && (
                  <div className="invalid-feedback">{formData.email.error}</div>
                )}
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  name="dateOfBirth"
                  className={`form-control ${
                    formData.dateOfBirth.error ? "is-invalid" : ""
                  }`}
                />
              ...
              <div className="mb-3">
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    type="text"
                    className={`form-control ${
                      formData.mobileNo.error ? "is-invalid" : ""
                    }`}
                  />
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className={`form-control ${
                    formData.aadhaarNumber.error ? "is-invalid" : ""
                  }`}
                  name="aadhaarNumber"
                />
