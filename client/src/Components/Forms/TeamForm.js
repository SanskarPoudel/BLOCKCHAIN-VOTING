...
const TeamForm = ({ voterContract, web3, onSuccess = null }) => {
  ...
  return (
    <form onSubmit={handleOnSubmit}>
      <h5>Register Candidate for Party</h5>
      <hr />
      <div className="row g-3 mb-3">
        <div className="col-md-6">
          ...
          {formData.team_name.error && (
            <div className="invalid-feedback">{formData.team_name.error}</div>
          )}
        </div>
        <div className="col-md-6">
      ...
      <div className="mb-3">
        ...
        <textarea
          ...
          onChange={handleChange}
          name="description"
          placeholder="Enter party and candidate description"
          className={`form-control ${
        ...
        {formData.description.error && (
          <div className="invalid-feedback">{formData.description.error}</div>
        )}
      </div>
